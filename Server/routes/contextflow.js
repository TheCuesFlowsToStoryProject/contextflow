...
//         const id = String(obj.domain);
//         if (check_context.length === 0) {
//           var checkAtn = await Context.find({
//             $and: [{ "contexts.atttentionentities": obj.atttentionentities }],
//           });
...
//             } else {
//               return res.send({
//                 err: "duplicate  atttentionentitie",
//               });
//             }
//           } else {
//             return res.send({
//               err: "duplicate useranchor,domain and flow",
//             });
//           }
//         } else {
//           return res.send({ err: "this context already exist" });
