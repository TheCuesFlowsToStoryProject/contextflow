...
//     .catch((error) => {
//       if (error.name === "MongoError" && error.code === 11000) {
//         res.send({ err: "duplicate user anchor" });
//       } else {
//         console.log(error);
//         res.send({ err: error });
//       }
...
// router.get("/get-resolution-pattern", async (req, res) => {
//   const anchor = JSON.parse(req.query.payload);
//   console.log(useranchor.resolution);
...
//   });
//   const user_anchor_id = ObjectId(userId._id).toString();
//   const resoLution_id = ObjectId(resoLutionId._id).toString();
//   // if (!resoLution_id) {
//   const query = { user_anchor: user_anchor_id };
//   var arr = await ResolutionPatternCollection.find(query);
...
//   //   var arr = await ResolutionPatternCollection.find(query);
//   // }
//   // const cursor = await ResolutionPatternCollection.find(query);
//   // ResolutionPatternCollection.collection.dropAllIndexes(function (
//   //   err,
//   //   results
//   // ) {
